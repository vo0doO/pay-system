...
unistream = f"""curl -s 'https://online.unistream.ru/card2cash/calculate?destination={country_dest}&amount={amount}&currency={currency_dest_name}&accepted_currency=RUB&profile=unistream_front' \
