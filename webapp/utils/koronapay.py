country_dest = "KAZ"
currency_dest_id = 840
amount = 1000

koronapay = f"""curl -s 'https://koronapay.com/transfers/online/api/transfers/tariffs?sendingCountryId=RUS&sendingCurrencyId=810&receivingCountryId={country_dest}&receivingCurrencyId={currency_dest_id}&paymentMethod=debitCard&receivingAmount={amount}&receivingMethod=cash&paidNotificationEnabled=true' \
